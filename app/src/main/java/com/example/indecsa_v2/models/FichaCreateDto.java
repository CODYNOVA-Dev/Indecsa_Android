...
public class FichaCreateDto {
    ...
    public FichaCreateDto() {}

    public FichaCreateDto(Integer idContratista, Integer idProyecto, String fichaEstado,
                          String fichaEspecialidad, List<Integer> trabajadoresIds) {
